...
public final class RavenSMPTeamMemberPreJoinEvent extends RavenCancellableEvent {

    private final @NotNull Player whoJoined;
    private final @NotNull RavenSMPTeamMember host;
