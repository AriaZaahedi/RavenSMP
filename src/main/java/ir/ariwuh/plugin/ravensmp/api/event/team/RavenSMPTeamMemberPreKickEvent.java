...
public final class RavenSMPTeamMemberPreKickEvent extends RavenCancellableEvent {

    private final @NotNull RavenSMPTeamMember whoKicked;
    private final @NotNull RavenSMPTeamMember kickedMember;
