...
public final class RavenSMPTeamPreTransferLeadershipEvent extends RavenCancellableEvent {

    private final @NotNull RavenSMPTeamMember oldTeamLeader;
    private final @NotNull RavenSMPTeamMember newTeamLeader;
